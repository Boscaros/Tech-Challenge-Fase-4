...
url_predicao = "https://raw.githubusercontent.com/Boscaros/Previs-o-Preco-Petr-leo/refs/heads/main/previs%C3%A3o%20preco%20petroleo.png"
st.image(url_predicao, use_column_width=True, caption="Previsão")

st.write('Fonte: Código Python disponível no Github')
st.write('Clique [aqui](https://github.com/Boscaros/Previs-o-Preco-Petr-leo/blob/main/Machine%20Learning%20Pre%C3%A7o%20do%20Petr%C3%B3leo.ipynb)')
...
for paragraph in paragraphs:
    ...
    img_url = "https://raw.githubusercontent.com/Boscaros/Previs-o-Preco-Petr-leo/refs/heads/main/preco%20petroleo%20pbi.png"

st.image(img_url, use_column_width=True, caption="Foto do Dashboard")

st.write('Clique [aqui](https://github.com/Boscaros/Previs-o-Preco-Petr-leo/blob/main/Pre%C3%A7o%20Petroleo.pbix) para abrir o arquivo Power BI no Github')
